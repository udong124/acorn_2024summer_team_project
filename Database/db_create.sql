...
CREATE SEQUENCE e_journal_id_seq
START WITH 1
INCREMENT BY 1;
...
CREATE SEQUENCE t_calendar_id_seq
START WITH 1
INCREMENT BY 1;

COMMIT;

ALTER TABLE MEMBERCALENDAR ADD FOREIGN KEY (member_num) REFERENCES MEMBER_INFO (member_num) ON DELETE CASCADE;

ALTER TABLE chat_room ADD constraint unique_member UNIQUE (member_num);

ALTER TABLE CHAT_ROOM ADD FOREIGN KEY (member_num) REFERENCES MEMBER_INFO (member_num) ON DELETE CASCADE;

ALTER TABLE EXERCISEJOURNAL ADD CONSTRAINT CAL_EXERCISEJOUNAL FOREIGN KEY (m_calendar_id) REFERENCES MEMBERCALENDAR (m_calendar_id) ON DELETE CASCADE;

ALTER TABLE DIETJOURNAL ADD  CONSTRAINT CAL_DIETJOURNAL FOREIGN KEY (m_calendar_id) REFERENCES MEMBERCALENDAR (m_calendar_id) ON DELETE CASCADE;

ALTER TABLE CHAT_ROOM ADD FOREIGN KEY (trainer_num) REFERENCES TRAINER_INFO (trainer_num);

ALTER TABLE TRAINERCALENDAR ADD FOREIGN KEY (trainer_num) REFERENCES TRAINER_INFO (trainer_num) ON DELETE CASCADE;
...
ALTER TABLE TRAINER_INFO ADD FOREIGN KEY (trainer_num) REFERENCES USER_INFO (id) ON DELETE CASCADE;

ALTER TABLE MEMBER_INFO ADD FOREIGN KEY (member_num) REFERENCES USER_INFO (id) ON DELETE CASCADE;

ALTER TABLE MEMBER_INFO ADD FOREIGN KEY (trainer_num) REFERENCES TRAINER_INFO (trainer_num);

ALTER TABLE CHAT_MESSAGE ADD FOREIGN KEY (topic) REFERENCES CHAT_ROOM(topic);
